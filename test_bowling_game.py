...
class TestBowlingGame(unittest.TestCase):
    ...
    def test_gutter_game(self):
        """Test a game where all rolls are gutter balls (0 pins)."""
    ...
    def test_one_spare(self):
        """Test a game with one spare followed by normal rolls."""
        self._roll_spare()
        self.game.roll(3)
    ...
    def test_one_strike(self):
        """Test a game with one strike followed by normal rolls."""
        self._roll_strike()
        self.game.roll(3)
        self.game.roll(4)
    ...
    def test_perfect_game(self):
        """Test a perfect game (all strikes = 300 points)."""
    ...
    def test_tenth_frame_strike(self):
        """Test strike in the tenth frame."""
        self._roll_many(18, 0)  
        self.game.roll(10)    
        self.game.roll(5)    
        self.game.roll(3)    
    ...
    def test_boundary_pins_valid(self):
        """Test boundary values for valid pin counts."""
    ...
    def test_frame_pin_total_validation(self):
        """Test that two rolls in a frame don't exceed 10 pins."""
...
class TestBowlingGameErrorHandling(unittest.TestCase):
    ...
    def test_negative_pins(self):
        """Test that negative pin counts are handled appropriately."""
    ...
    def test_too_many_pins(self):
        """Test that pin counts over 10 are handled appropriately."""
        try:
            self.game.roll(11)
    ...
    def test_too_many_pins_per_frame(self):
        """Test that frame totals over 10 are handled (except strikes)."""
        try:
            self.game.roll(7)
            self.game.roll(8)  
